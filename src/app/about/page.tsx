    ...
    <div className="w-full bg-[#FAF9F5] min-h-screen py-16 px-6 md:px-12 lg:px-20">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-serif text-[#1C3516] tracking-tight mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-stone-200 shadow-sm flex flex-col justify-between">
            <div>
              <div className="h-12 w-12 rounded-2xl bg-[#1C3516]/10 flex items-center justify-center text-[#1C3516] mb-6">
                <Sparkles className="size-6" />
              </div>
              <h3 className="text-2xl font-serif text-[#1C3516] mb-3">Pure & Authentic Spices</h3>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-stone-200 shadow-sm flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-2xl font-serif text-[#1C3516] mb-3">100% Biodegradable Tableware</h3>
              <p className="text-sm md:text-base text-stone-600 leading-relaxed font-sans">
        ...
        {/* Core Values Banner */}
        <div className="bg-[#1C3516] rounded-3xl p-8 md:p-12 text-amber-50 mb-20 shadow-lg">
          <div className="text-center max-w-xl mx-auto mb-12">
            <h2 className="text-2xl md:text-3xl font-serif text-amber-100 mb-3">What Drives Us Every Day</h2>
        ...
        <div className="text-center">
          <h3 className="text-2xl md:text-3xl font-serif text-[#1C3516] mb-4">Ready to make the switch to sustainable living?</h3>
          <p className="text-sm text-stone-600 max-w-md mx-auto mb-8 font-sans">
            Explore our range of pure kitchen spices and biodegradable tableware today.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/products"
              className="inline-flex items-center gap-2 bg-[#1C3516] text-amber-50 px-8 py-3.5 rounded-xl text-sm font-medium shadow-md transition-all hover:bg-[#274a20]"
            >
              Explore Products
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-stone-900 border border-stone-300 px-8 py-3.5 rounded-xl text-sm font-medium transition-all hover:bg-stone-50"
            >
              Contact Us
            </Link>
          </div>
