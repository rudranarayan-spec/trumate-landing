...
export default function DealsSection() {
  return (
    <section className="w-full bg-[#FAF9F5] py-12 md:py-20 lg:py-24 px-4 sm:px-6 md:px-12 lg:px-20">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-10 gap-4">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-[#1C3516] tracking-tight">
        ...
        {/* Two Banner Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-6 md:mb-8">
          
          {/* Left Card: Biodegradable Tableware Combo */}
          <div className="relative group overflow-hidden rounded-2xl bg-stone-950 aspect-[4/3] sm:aspect-[16/10] md:aspect-[4/3] flex flex-col justify-end p-6 sm:p-8 md:p-10 shadow-lg">
            ...
            <div className="relative z-20">
              <span className="inline-block bg-white/20 backdrop-blur-md text-amber-100 text-[10px] sm:text-[11px] font-semibold tracking-widest px-3 py-1 rounded-full uppercase mb-2.5 sm:mb-3">
                Eco Bundle
              </span>
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-white font-bold tracking-tight mb-1.5 sm:mb-2">
                15% <span className="text-lg sm:text-xl md:text-2xl font-sans font-normal text-amber-200">OFF</span>
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-medium text-amber-50 mb-1">
                Green Tableware Pack
              </h3>
              <p className="text-xs sm:text-sm text-stone-300 mb-5 sm:mb-6 max-w-sm">
                Compostable plates, bowls & wooden cutlery. The more you stock, the more you save.
              </p>
              <Link
                href="/products?category=biodegradables"
                className="inline-flex items-center gap-2 bg-white text-stone-900 px-4 sm:px-5 py-2.5 rounded-lg text-xs md:text-sm font-medium transition-all hover:bg-amber-100 shadow-sm active:scale-95"
              >
                Grab the Deal
          ...
          <div className="relative group overflow-hidden rounded-2xl bg-stone-950 aspect-[4/3] sm:aspect-[16/10] md:aspect-[4/3] flex flex-col justify-end p-6 sm:p-8 md:p-10 shadow-lg">
            ...
            <div className="relative z-20">
              ...
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-white font-bold tracking-tight mb-1.5 sm:mb-2">
                20% <span className="text-lg sm:text-xl md:text-2xl font-sans font-normal text-amber-200">OFF</span>
              </div>
              <h3 className="text-base sm:text-lg md:text-xl font-medium text-amber-50 mb-1">
        ...
        <div className="w-full bg-[#1C3516] rounded-2xl p-5 sm:p-6 md:p-8 text-amber-50 shadow-md">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm sm:text-base md:text-lg font-serif font-medium text-amber-100">
