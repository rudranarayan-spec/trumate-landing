...
export default function WhyChooseUs() {
  return (
    <section className="relative w-full py-24 md:py-32 overflow-hidden bg-stone-900">
      
      {/* Background Image Container (Replace '/eco-bg.png' with your asset) */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {features.map((item, index) => {
            ...
            return (
              ...
              >
                <div>
                  <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[#1C3516]/10 text-[#1C3516] mb-5">
