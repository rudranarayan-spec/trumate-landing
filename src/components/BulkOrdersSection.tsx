...
export default function BulkOrdersSection() {
  return (
    <section className="w-full bg-[#FAF9F5] py-16 md:py-24 px-6 md:px-12 lg:px-20 border-t border-stone-200/60">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-14">
          ...
          <div className="lg:col-span-8">
            ...
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-serif text-[#1C3516] tracking-tight mb-4">
              Bulk Orders, made simple.
            </h2>
            <p className="text-sm md:text-base text-stone-600 max-w-2xl leading-relaxed font-sans">
          ...
          <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col items-start lg:items-end justify-center gap-3">
            <Link
              ...
              className="inline-flex items-center gap-2.5 bg-[#1C3516] text-amber-50 px-6 py-3.5 rounded-xl text-sm font-medium shadow-md transition-all hover:bg-[#274a20] active:scale-95"
            >
            ...
            <Link
              href="/bulk-orders"
              className="inline-flex items-center gap-1.5 text-xs md:text-sm font-medium text-stone-800 hover:text-[#1C3516] transition-colors py-1"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="bg-white/80 border border-stone-300/70 rounded-2xl p-7 md:p-8 flex flex-col justify-between shadow-xs transition-all hover:shadow-md">
            <div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg md:text-xl font-serif font-medium text-[#1C3516]">
                  Small Business
                </h3>
              </div>
              <div className="h-px w-full bg-stone-200 mb-5"></div>
              <p className="text-xs md:text-sm text-stone-600 leading-relaxed mb-8 font-sans">
